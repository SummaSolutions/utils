 ...
 *
 */
class Summa_Cms_Block_Adminhtml_Cms_Block_Grid
    extends Mage_Adminhtml_Block_Cms_Block_Grid
{
    ...
    {
        $this->addExportType('*/cms/fullCsvExportBlocks', $this->helper('summa_cms')->__('Full CSV Export'));
    ...
    public function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('export', array(
            ...
            'url'   => $this->getUrl('*/cms/massCsvExportBlocks')
        ));
