 ...
 * Date: 5/3/13
 */
class Summa_AutoSuggest_Model_Adapter_HttpStream
    extends Enterprise_Search_Model_Adapter_HttpStream
{
    /**
    ...
    protected function _search($query, $params = array())
    {
        ...
        foreach ($sortFields as $sortField) {
            if ($sortField['sortField'] == 'attr_sort_score'.$languageSuffix) {
                $searchParams['sort'][] = 'score ' . $sortField['sortType'];
            } else {
